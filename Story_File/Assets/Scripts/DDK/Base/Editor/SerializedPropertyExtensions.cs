...
public static class SerializedPropertyExtensions
{
	...
	public static T GetFieldByName<T>( this object obj, string fieldName, BindingFlags bindingFlags = BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance )
	{
