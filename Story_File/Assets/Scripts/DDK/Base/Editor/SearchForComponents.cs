//This was downloaded from https://forum.unity3d.com/threads/editor-want-to-check-all-prefabs-in-a-project-for-an-attached-monobehaviour.253149/
...
namespace DDK.Base
{
    public class SearchForComponents : EditorWindow {
        [MenuItem( "Custom/Search For Components.." )]
        static void Init () {
