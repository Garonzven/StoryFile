...
/// This is useful as a performance optimization since it is faster to render one big mesh than many small meshes. 
/// See the docs on graphics performance optimization for more info
/// 
...
public class CombineChildrenExtended : MonoBehaviour {
	...
	public bool generateTriangleStrips = true, combineOnStart = true, destroyAfterOptimized = false;
	public UnityEngine.Rendering.ShadowCastingMode shadowCastingMode;
	public bool receiveShadow = true, keepLayer = true, addMeshCollider = false;
	...
	public void Combine () {
		...
		foreach (DictionaryEntry de  in materialToMesh) {
			...
			if (materialToMesh.Count == 1)
			{
                ...
                GetComponent<Renderer>().shadowCastingMode = shadowCastingMode;
			...
			else
			{
                ...
                go.GetComponent<Renderer>().shadowCastingMode = shadowCastingMode;
