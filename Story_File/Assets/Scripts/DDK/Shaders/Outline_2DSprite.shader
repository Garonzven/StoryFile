Shader "Custom/Outline_2DSprite" 
  {
    ...
    
       {
           ...
           {
               fixed4 TempColor = (tex2D(_MainTex, IN.uv_MainTex+float2(_OutLineSpreadX,_OutLineSpreadY)) + tex2D(_MainTex, IN.uv_MainTex-float2(_OutLineSpreadX,_OutLineSpreadY))) * _Color.rgba;
               ...
               o.Alpha = mainColor.a;// - (1 - _Color.a);
           }
           ENDCG       
       }
